...
namespace Fenix\Orm\Collection;

use Fenix\Orm\Pagination\PaginationResolverBootstrap;
...
use Fenix\Orm\Pagination\Pagination;
...
/**
    ...
    */
    ...
    public function __construct($items = [])
    {
        ...
        static::$pages = new Pagination($this->toArray());
    }
